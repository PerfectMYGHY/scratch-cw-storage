...
export declare class ScratchStorage {
    ...
    webHelper: WebHelper;
    private _helpers;
    private currentProjectAssets;
    private projectAssetsOK;
    eventEmitter: EventEmitter;
    assetHost: string;
    currentAssetFrom: string;
    constructor();
    /**
     ...
     * 删除当前作品的总资源记录
     */
    clearCurrentProjectAssets(): void;
    /**
     * 向当前作品总资源记录中添加资源ID
     ...
     */
    addAssetToCurrentProjectAssets(assetType: AssetType, assetId: string, dataFormat: DataFormat, addExt: boolean | undefined, useObject: boolean | undefined, data: AssetData | undefined): void;
    /**
     * 获取当前作品总资源记录
     ...
     * 完结当前作品总资源记录
     */
    finishCurrentProjectAssets(): void;
    /**
     * 获取当前作品总记录是否完结
